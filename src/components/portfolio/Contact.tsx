...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 px-6 md:px-12 max-w-7xl mx-auto">
      <p className="font-mono text-[11px] tracking-[0.25em] uppercase text-mint mb-6">
        007 — LET'S TALK
      </p>
      <h2
        className="font-display font-extrabold tracking-tight leading-[0.95] mb-20"
        ...
        {/* <div className="lg:w-1/2">
          <form onSubmit={handleSubmit} className="space-y-8">
            {[
              ...
              <div key={name}>
                <label className="font-mono text-[10px] uppercase tracking-[0.2em] text-text-secondary block mb-2">
                  {label}
                </label>
                <input
                  type={type}
