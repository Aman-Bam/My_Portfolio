...
const About = () => {
  ...
  return (
    <section id="about" className="pt-16 pb-32 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20">
          <div className="lg:w-[55%]">
            ...
            {[
              ...
              "I debug production systems at 2 AM because I care how things work under the hood as much as how they look on screen. Obsessed with systems thinking, developer tooling, and building UX that doesn't suck."
            ].map((text, i) => (
              <motion.p
                key={i}
